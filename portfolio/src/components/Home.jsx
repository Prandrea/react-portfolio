...
const Home = () => {
  ...
  <div name='home' className='w-full h-screen'>
    ...
    className='bg-cover flex flex-col justify-center text-left h-full'>
      ...
      <h1 className='pl-40 ml-8 max-w-[1000px] px-8 text-4xl sm:text-7xl font-bold text-pink-600'>Andrea Prado</h1>
        <h2 className='pl-40 ml-8 max-w-[1000px] px-8 text-4xl sm:text-7xl font-bold text-purple-700'></h2>
        <Typed
        ...
        loop
        />
      <p className='pl-40 ml-8 px-8 text-black py-4 max-w-[500px]'> </p>
      <div>
